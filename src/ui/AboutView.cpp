...
AboutView::AboutView()
{
    ...
    body.setText (
        ...
        "Make a Beat / Reroll. \"Keep the kick, gamble the rest.\"\n"
        "\n"
        "Pads  -  click a pad to audition it; drag an audio file onto a pad to load it. "
        "Keys 1234 / QWER / ASDF / ZXCV trigger the 16 pads; Space plays the kick.\n"
        "\n"
        ...
        "Humanise knob loosens timing and velocity so beats don't sound robotic.\n"
        "\n"
        ...
        "\n"
        "Library  -  scan a folder of samples, browse, and NEW KIT builds a playable kit.\n"
        "\n"
