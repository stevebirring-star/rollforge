...
AboutView::AboutView()
{
    ...
    body.setText (
        ...
        "bottom edge to trim the sample. RIGHT-CLICK a pad for its TONE (tilt it darker "
        "or brighter) and SEND (how much of it feeds the reverb). Keys 1234 / QWER / "
        "ASDF / ZXCV trigger the 16 pads; Space plays the kick.\n"
        "\n"
