...
> **Status:** Phase 1 (pads + playback engine) complete — 16-pad sampler with
> voice-stealing, choke groups, drag-drop loading, and keyboard + MIDI input;
> CI green on Linux + Windows. See [`PLAN.md`](PLAN.md) for the
